                ...
                <div className="container mx-auto max-w-4xl section-padding-x space-y-8" data-reveal>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div className="bg-white p-6 rounded-2xl border border-(--line) shadow-sm">
                            ...
                            <h3 className="font-bold text-lg text-(--charcoal) mb-2">Pakaian Nyaman</h3>
                        ...
                        <div className="bg-white p-6 rounded-2xl border border-(--line) shadow-sm">
                            ...
                            <h3 className="font-bold text-lg text-(--charcoal) mb-2">Sopan & Ramah</h3>
                            <p className="text-xs text-(--charcoal-soft) leading-relaxed">
                        ...
                        <div className="bg-white p-6 rounded-2xl border border-(--line) shadow-sm">
                            ...
                            <h3 className="font-bold text-lg text-(--charcoal) mb-2">Jaga Kelestarian</h3>
                            <p className="text-xs text-(--charcoal-soft) leading-relaxed">
