...
export default function BlogsIndex({
    ...
    const [blogToDelete, setBlogToDelete] = useState<BlogWithRelations | null>(
        null,
    );
    ...
    return (
        <>
            ...
            <div className="flex flex-col gap-6 p-6">
                ...
                <Dialog
                    open={!!blogToView}
                    onOpenChange={(o) => !o && setBlogToView(null)}
                >
                        ...
                        {blogToView && (
                            <div className="grid gap-4 py-4">
                                ...
                                <div className="grid grid-cols-4 items-center gap-4">
                                    ...
                                    <span className="col-span-3 text-sm">
                                        {formatDate(blogToView.created_at)}
                                    </span>
                                </div>
                                <div className="grid grid-cols-4 items-center gap-4">
                                    <span className="text-right text-sm font-medium text-[oklch(0.48_0.01_85)]">
                                    ...
                                    <span className="col-span-3 text-sm">
                                        {blogToView.views_count.toLocaleString(
                                            'id-ID',
                                        )}{' '}
                                        views
                                    </span>
                ...
                <AlertDialog
                    open={!!blogToDelete}
                    onOpenChange={(o) => !o && setBlogToDelete(null)}
                >
                    <AlertDialogContent>
                        <AlertDialogHeader>
                            <AlertDialogTitle>
                            ...
                            <AlertDialogDescription>
                                ...
                                <strong>{blogToDelete?.title}</strong>. Data
