...
import { Bold, Heading2, Italic, List, ListOrdered, Quote, Strikethrough, Undo, Redo } from 'lucide-react';
...
export function EditorToolbar({ editor }: EditorToolbarProps) {
    ...
    const divider = <div className="mx-1 w-px self-stretch bg-[oklch(0.22_0.01_85/8%)]" />;
