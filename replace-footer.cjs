...
const getIconName = (svg) => {
    if (svg.includes('x="3" y="3" width="18" height="18" rx="5"')) return 'Instagram';
    if (svg.includes('M14 9h3V6h-3a4 4 0 00-4 4v2H7v3h3v6h3v-6h3l1-3h-4v-2a1 1 0 011-1z')) return 'Facebook';
    if (svg.includes('M11 10l4 2-4 2v-4z')) return 'Youtube';
    if (svg.includes('M22 16.92v3a2 2 0 01-2.18 2')) return 'Phone';
    if (svg.includes('M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z')) return 'Mail';
